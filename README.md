...
Drop the folder in `cartridges/`, reload Arborito, and the game appears in the Arcade. **You did not write a single quiz question** — the lesson author did, you just rendered them.
...
api = Arborito.from_arborito("../examples/ingles-a1-demo.arborito", lang="ES")
