...
|--------|----------|------------------|
| **`.arborito`** | Exported trees / demos (`examples/*.arborito`) | `static` (Quiz V2, no LLM) |
...
python3 examples/quiz_game.py --arborito ../../examples/ingles-a1-demo.arborito --rounds 10
